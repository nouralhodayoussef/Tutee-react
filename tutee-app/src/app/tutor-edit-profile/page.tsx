              ...
              <form className="flex-1 space-y-6" onSubmit={handleSubmit}>
                <div className="flex flex-wrap gap-6">
                  <div className="w-full md:w-[48%]">
                    <input
                      ...
                      className={`w-full border ${firstNameError ? "border-red-500" : "border-[#E8B14F]"
                  ...
                  <div className="w-full md:w-[48%]">
                    <input
                      ...
                      className={`w-full border ${lastNameError ? "border-red-500" : "border-[#E8B14F]"
                        } rounded-full px-6 py-2`}
                    />
                    {lastNameError && (
                ...
                >
                  {majors
                    ...
                    .map((m: any) => (
                      <option key={m.major_id ?? m.id} value={m.major_id ?? m.id}>
                        {m.major_name}
                      </option>
                    ))}
                </select>
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl mt-1 w-full max-h-40 overflow-y-auto z-10 shadow-sm">
                      {filteredSkills.length > 0 ? (
                        ...
                        <div className="px-4 py-2">
                          ...
                          <button
                            className={`rounded-full px-4 py-1 text-sm font-medium ${alreadyExists
