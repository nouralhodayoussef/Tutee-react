  ...
  const validateInputs = () => {
    ...
    if (
      ...
      (inputFirstName.length < 2 ||
        inputFirstName.length > 25 ||
        !nameRegex.test(inputFirstName))
    ) {
      setFirstNameError(
        "First name must be 2–25 letters and no special characters."
      );
      valid = false;
    } else {
      setFirstNameError("");
    ...
    if (
      ...
      (inputLastName.length < 2 ||
        inputLastName.length > 30 ||
        !nameRegex.test(inputLastName))
    ) {
      setLastNameError(
        "Last name must be 2–30 letters and no special characters."
      );
      valid = false;
    } else {
      setLastNameError("");
